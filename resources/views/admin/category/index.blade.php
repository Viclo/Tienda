                  ...
                  <tbody>
                    @foreach ($categorias as $categoria)
                        <tr>
                            ...
                            <td> <a class = "btn btn-default" href="{{ route('admin.category.show', $categoria->slug) }}">Ver</a></td>
                            <td> <a class = "btn btn-info" href="{{ route('admin.category.edit', $categoria->slug) }}">Editar</a></td>
                            <td> <a class = "btn btn-danger" href="{{ route('admin.category.index') }}" v-on:click.prevent="deseasEliminar({{$categoria->id}})"><i class="fas fa-trash-alt"></i></a></td>  
                        </tr>
                    @endforeach
                  </tbody>
                </table>
